...
<head>
<title>opussitelayout07users.jpg</title>
...
<!-- fwtable fwsrc="opussitelayout07user.png" fwbase="opussitelayout07users.jpg" fwstyle="Dreamweaver" fwdocid = "685216091" fwnested="0" -->
  ...
  <tr>
   ...
   <cfif Session.userID EQ 0><cflogout>
   <cfif url.loginfailed EQ "yes"><p align="center" style="margin-top:0px; margin-bottom: 0px; color:red">Bad Login. Try again.</p>
				...
				<form id="loginform" name="loginform" method="post" action="index.cfm" target="_top">
					 <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
					 	<tr>
							<td colspan="3" align="right"><a href="http://downtown304.com/profileNew.cfm" target="opusviewmain">new account</a> | <a href="profileForgotPass.cfm" target="opusviewmain">forgot password</a></td>
						</tr>
						<tr>
							<td align="right">username:</td>
							<td width="10">&nbsp;</td>
							<td align="right"><input name="username" type="text" id="username" size="12" maxlength="20" <cfif Cookie.username NEQ ""><cfoutput>value="#Cookie.username#"</cfoutput></cfif>/></td>
						</tr>
						<tr>
							<td align="right">password:</td>
							<td>&nbsp;</td>
							<td align="right"><input name="password" type="password" id="password" size="12" maxlength="20" /></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
