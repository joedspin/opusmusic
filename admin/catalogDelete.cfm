...
<p><b>Are you sure you want to permanently delete this item and all tracks associated with it?</b><br />
THIS ACTION CANNOT BE UNDONE!</p>
<cfoutput><p><a href="catalogDeleteAction.cfm?ID=#url.ID#&artistID=#thisItem.artistID#&pageBack=#url.pageBack#">YES</a> | <a href="catalogEdit.cfm?ID=#url.ID#&pageBack=#url.pageBack#">NO</a></p></cfoutput>
