...
<table border="0" cellpadding="0" cellspacing="1" bordercolor="#FFFFFF" style="border-collapse: collapse;">
			...
			<cfoutput query="myCards">
				<tr>
				  ...
				  <td colspan="2"><font color="##CCCCCC">Stored #PayName# ending in #Right(theCard,"4")#</font><font color="red"> EXPIRED DO NOT USE</font></td>
                    <cfelse>
				  <td colspan="2"><cfinput type="radio" name="cardChoice" value="#myCards.ID#" required="yes" message="Please select a Payment Method." checked="#optionCheck#"></td><td colspan="2"><font color="##CCCCCC">Stored #PayName# ending in #Right(theCard,"4")#</font></td>
                  </cfif>
				</tr>
				<cfset noCheck=false>
			</cfoutput>
    ...
    <cfelse>
    	<p>Payment type is <img src="https://www.paypal.com/en_US/i/logo/PayPal_mark_37x23.gif" align="left" style="margin-right:7px;"><span style="font-size:11px; font-family: Arial, Verdana;">The safer, easier way to pay.<!---The PayPal payment option is temporarily unavaialble.//---></span><br />
        <b>Capture is the only option.</b></p>
    </cfif>
