...
<cfquery name="imports" datasource="#DSN#">
	...
	where dateShipped><cfqueryparam cfsqltype="cf_sql_date" value="2013-12-31"> AND dateShipped < <cfqueryparam cfsqltype="cf_sql_date" value="2015-01-01"> AND shelfID=11 AND statusID=6 AND adminAVAILID=6
...
<cfoutput query="imports">
    ...
    <cfset catCount=catCount+qtyOrdered>
    <cfset catCost=catCost+(qtyOrdered*cost)>   
    <cfset catValue=catValue+(qtyOrdered*price)>
</cfoutput>
