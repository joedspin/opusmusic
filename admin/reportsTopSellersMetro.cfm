...
<cfquery name="topSellers" datasource="#DSN#" maxrows="100">
	SELECT orderItems.catItemID, Sum(orderItems.qtyOrdered) AS SumOfQuantity, catItemsQuery.catnum, catItemsQuery.label, catItemsQuery.artistID, catItemsQuery.artist, catItemsQuery.title, catItemsQuery.price
...
WHERE orderItems.adminAvailID=6 AND vendorID=5650
GROUP BY orderItems.catItemID, catItemsQuery.catnum, catItemsQuery.label, catItemsQuery.artistID, catItemsQuery.artist, catItemsQuery.title, catItemsQuery.price, catItemsQuery.catnum, vendorID
