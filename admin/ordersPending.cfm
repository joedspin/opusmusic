...
<h1>Opus</h1>
<p>Currently viewing QUICK VIEW. <a href="ordersPendingFullView.cfm">Click here for FULL VIEW.</a></p>
			...
			<cfif thisItems.recordCount NEQ 0>
				...
				<table cellpadding="2" border="1" style="border-collapse:collapse; margin-top: 15px;" width="1000">
					<tr>
						...
						<a href="ordersEdit.cfm?ID=#ordersWaiting.ID#&pageBack=ordersPending.cfm">EDIT</a><br />
						<a href="ordersPaid.cfm?ID=#ordersWaiting.ID#&pageBack=ordersPending.cfm">CLOSE</a><br />
						<a href="ordersEmailAdmin.cfm?ID=#ordersWaiting.ID#&paid=7&pageBack=ordersPending.cfm">EMAIL ADMIN</a><br />
						<a href="ordersView.cfm?ID=#ordersWaiting.ID#" target="_blank">VIEW</a><br />
						<cfif issueResolved>
						<a href="ordersPay.cfm?ID=#ordersWaiting.ID#">CHARGE</a><br />
						<a href="ordersPaid.cfm?ID=#ordersWaiting.ID#&paid=4&pageBack=ordersPending.cfm">PAID</a>
						<cfelse>
							<a href="ordersUpdateInvoice.cfm?ID=#ordersWaiting.ID#">INVOICE</a>
						</cfif>
						</td>
						...
						<b>Checked Out</b><br />
						#DateFormat(datePurchased,"mm/dd/yy")#<br />
						<cfif statusID EQ 1>
							<font color="red">#statusName#</font>
						<cfelseif statusID EQ 2 OR statusID EQ 3>
							<font color="yellow">#statusName#</font>
						<cfelseif statusID EQ 4>
							<font color="green">#statusName#</font>
						</cfif>
						</td>
						<td valign="top" width="780">#firstName# #lastName#<!---<br />
						#add1#<br />
