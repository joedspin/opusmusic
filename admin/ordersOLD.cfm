...
<h1>Opus</h1>
<p>Currently viewing QUICK VIEW. <a href="ordersFullView.cfm">Click here for FULL VIEW.</a></p>
...
<cfelse>
	<cfoutput><p>Number of orders waiting: #ordersWaiting.recordCount#</p></cfoutput>
		...
		<cfoutput query="ordersWaiting">
			...
			<cfif (statusID EQ 2 AND thisItems.recordCount NEQ 0) OR statusID GT 2>
				...
				<table cellpadding="2" border="1" style="border-collapse:collapse; margin-top: 15px;" width="1000" >
					<tr>
						...
						<a href="ordersAllAvail.cfm?ID=#ordersWaiting.ID#">ALL AVAILABLE</a><br />
