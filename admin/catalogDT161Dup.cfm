...
<cfoutput query="thisItem">
	...
	<b>#artist#</b><br />
	#title#<br />
	<small>#catnum# #label# #media#</small></p>
</cfoutput>
...
<cfif mergeItem.recordCount EQ 1>
	<p style="font-size:16px; color:#FFCC33; margin-left: 30px;"><b>MATCH THE ABOVE ITEM WITH THE BELOW ONE?</b><br />
THIS ACTION CANNOT BE UNDONE!</p>
<cfoutput><p style="font-size:16px; color:##FFCC33; margin-left: 30px;"><a href="catalogDT161DupAction.cfm?ID=#url.ID#&mergeID=#mergeItem.ID#">YES</a> | <a href="catalog.cfm">NO</a></p></cfoutput>
