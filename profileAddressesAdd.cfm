...
<cfquery name="countries" datasource="#DSN#" cachedWithin="#CreateTimeSpan(0, 0, 0, 15)#">
	select *
	from countries
	order by name
</cfquery>
...
<cfform name="address" id="address" method="post" action="profileAddressesAddAction.cfm">
