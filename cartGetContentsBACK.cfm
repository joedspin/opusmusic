...
<cfif Session.userID NEQ "0">
	...
	<cfif NOT binsOnly>
		  <cfif DateFormat(varDateODBC,"yyyy-mm-dd") LTE "2013-10-01">
            ...
            <cfif salePercentSummer.numItems GT 0>
            	<cfif salePercentSummer.numItems GTE 5>
					<cfif salePercentSummer.numItems LT 20>
                        <cfset bigSalePerc=(100-salePercentSummer.numItems)/100>
                    <cfelse>
