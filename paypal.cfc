<cfcomponent displayname="PayPal" hint="PayPal Gateway">
	...
	<cffunction name="PPInitialize" returntype="void" output="no">
		...
		<cfset p12Certificate = "d:\inetpub\opusrecords\certs\paypalopuslive_cert.p12">
		...
		<cfscript>
			...
			pp_profile.setAPIUsername("order_api1.downtown304.com");
			pp_profile.setAPIPassword("ZL6JFXSX4GWTJZTU");
			pp_profile.setCertificateFile(p12certificate);
			pp_profile.setPrivateKeyPassword("belushko");
