...
<cfset binsOnly="true">
<cfif url.user EQ "no">
<p style="margin-left: 10px; margin-top: 10px; margin-right: 10px;"><font color="yellow" size="2">Please login to use the shopping cart</font></p>
</cfif>
...
<cfif url.checkout NEQ "start">
  ...
  <tr>
   ...
   <cfset thisSub=0>
		<cfif cartContents.recordCount GT 0>
			...
			<cfoutput query="cartContents">
				...
				<cfset thisSub=thisSub+qtyOrdered*price></tr>
			</cfoutput>
			</table>
			<cfoutput><p><b>Order Subtotal: #DollarFormat(thisSub)#</b></p></cfoutput>
			<cfif Session.userID NEQ 0 AND Session.userID NEQ ""><cfoutput><p><a href="https://downtown304.com/checkOut.cfm?dsu=#URLEncodedFormat(Encrypt(Session.userID,'y6DD3cxo86zHGO'))#" target="_top">Check Out</a></p></cfoutput><!---?userID=<cfoutput>#Session.userID#</cfoutput>//--->
			<cfelse>
   ...
   <td background="images/opussitelayout07bins_r4_c3.jpg"><img src="spacer.gif" width="1" height="1" /></td>
  ...
  <tr>
   ...
   <td rowspan="3" background="images/opussitelayout07bins_r9_c3.jpg"><img src="spacer.gif" width="1" height="1" /></td>
...
<p align="center"><img src="images/cards.jpg" alt="We accept PayPal, MasterCard, American Express, and Visa" width="147" height="26" /><br />
 <a href="http://www.facebook.com/pages/Downtown-304/22600676199" target="_blank"><img src="images/find_us_on_facebook_badge.gif" alt="facebook" width="144" height="44" vspace="4" border="0" /></a><br />
  <a href="http://www.myspace.com/opusrecordsnyc" target="_blank"><img src="images/mySpaceLogo.jpg" alt="myspace.com" width="100" height="21" vspace="4" border="0" /></a></p>
